...
//import Principal.*;
import DAO.Viewer;
import Resolver.ViewerPersonController;
...
public class LoginExitController extends javax.swing.JFrame {

    public LoginExitController() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel2.add(txt_user, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 130, 390, -1));
        ...
        setSize(new java.awt.Dimension(459, 358));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(password.equals("Security")| password.equals("Admin")){//only pass
            ViewerPersonController dbviewer = null;
            try {
                dbviewer = new ViewerPersonController(user); //Intance form "Menu"
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginExitController.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoginExitController().setVisible(true);
            }
        });
    }
