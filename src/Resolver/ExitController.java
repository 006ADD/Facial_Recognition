 ...
 * @author User
 */
public class ExitController extends javax.swing.JFrame {

    private ExitController.DaemonThread myThread = null;
    ...
    public ExitController(String user) {
        initComponents();
    ...
    private void initComponents() {
        ...
        label_enterTime.setText("Время ухода");
        ...
        jPanel2.add(save, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 270, 160, 80));
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        ...
        try {
            ...
            if (!idString.isEmpty() && idString.matches("\\d+")) {
                ...
                //exit.setPersonId(personId);
            }
            controllerModel.setExitDate(time());
            //exit.setExitDate(time());

            controllerDB.insertExit(controllerModel);
            //exitDAO.insertExit(controllerModel);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExitController.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExitController().setVisible(true);
            }
        });
    }
    ...
    public void startCamera() {
        new Thread() {
            ...
            public void run() {
                ...
                myThread = new ExitController.DaemonThread();
