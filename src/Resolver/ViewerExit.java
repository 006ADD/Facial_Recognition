 ...
 * @author User
 */
public class ViewerExit extends javax.swing.JDialog {
...
int id;
   ...
   public ViewerExit(java.awt.Frame parent, boolean modal) throws SQLException {
    super(parent, modal);
    initComponents(); // Вызов инициализации компонентов
    paint_table();
    //enterDAO.filltable("SELECT * FROM Enter WHERE person_id",table);
    exitDAO.filltable("SELECT * FROM Enter ",table);
}
    
    public ViewerExit(String user) throws SQLException{
        initComponents();
        paint_table();
        exitDAO.filltable("SELECT * FROM Enter ",table);
    }
    ...
    private void txt_searchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_searchKeyReleased
        try {
            exitDAO.filltable("SELECT * FROM Enter WHERE person_id " + txt_search.getText(), table);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ViewerExit dialog = new ViewerExit(new javax.swing.JFrame(), true);
                    ...
                    Logger.getLogger(ViewerExit.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });    
    }
